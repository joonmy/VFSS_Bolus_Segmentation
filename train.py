...
from trainer import trainer_vfss

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='/mnt/hdd3/VFSS/Data/Randomly_divided_dataset', help='root dir for data')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'VFSS': {
            'root_path': '/home/younghun/VFSS/Data_0523Split[Undersampling]/3graychannel_0422',
            'num_classes': 6,
        },
    }
